...
class OriginWorkspace {
    ...
    async load() {
        ...
        console.info("Origin package root loaded: ", bold(rootPackage.content.name));
...
class LPCK {
    ...
    #loadArgs(args) {
        ...
        const { preset, printPresets, init, prepack, rawInstall, dev, peer } = parsedArgs.values;
    ...
    #help() {
        ...
        console.info("  --rawInstall: Run install without specifying the packages to install");
    }
    #printPresets() {
