...
class WorkspaceHandler {
    ...
    async updateToLocalPacks(availablePackages) {
...
class TargetWorkspace {
    ...
    async install(availablePackages, rawInstall) {
...
class LPCK {
    ...
    #loadArgs(args) {
        ...
        const { preset, printPresets, init, noPrepack, rawInstall } = parsedArgs.values;
    ...
    async #install(originPackageDir) {
        ...
        await targetPackage.install(originPackage.getAvailablePackages(), this.#args.rawInstall);
        this.#cleanUpPacks();
